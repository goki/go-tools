...
// Options is github.com/goki/go-tools/imports.Options with extra internal-only options.
type Options struct {
...
// Process implements github.com/goki/go-tools/imports.Process with explicit context in opt.Env.
