...
func TestSpecialOld(t *testing.T) { // exercises lcs.fix
	a := "github.com/goki/go-tools/intern"
	b := "github.com/google/safehtml/template\"\n\t\"github.com/goki/go-tools-tools/intern"
...
func TestRegressionOld001(t *testing.T) {
	a := "// Copyright 2019 The Go Authors. All rights reserved.\n// Use of this source code is governed by a BSD-style\n// license that can be found in the LICENSE file.\n\npackage diff_test\n\nimport (\n\t\"fmt\"\n\t\"math/rand\"\n\t\"strings\"\n\t\"testing\"\n\n\t\"github.com/goki/go-tools-tools/gopls/internal/lsp/diff\"github.com/goki/go-toolsoki/go-tools/internal/diff/diffgithub.com/goki/go-tools.com/goki/go-tools/gopls/internal/span\"\n)\n"
