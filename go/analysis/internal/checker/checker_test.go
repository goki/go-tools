...
import (
	...
	"github.com/goki/go-tools/go/analysis/internal/checker"
...
func TestURL(t *testing.T) {
	...
	pkgname := &analysis.Analyzer{
		...
		URL:  "https://pkg.go.dev/github.com/goki/go-tools/go/analysis/internal/checker",
	...
	want := []string{"https://pkg.go.dev/github.com/goki/go-tools/go/analysis/internal/checker"}
