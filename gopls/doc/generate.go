...
func doMain(write bool) (bool, error) {
	...
	sourceDir, err := pkgDir("github.com/goki/go-tools/gopls/internal/lsp/source")
	if err != nil {
		return false, err
	}
	...
	goplsDir, err := pkgDir("github.com/goki/go-tools/gopls")
	if err != nil {
		return false, err
	}
...
func rewriteAPI(_ []byte, api *source.APIJSON) ([]byte, error) {
	...
	fmt.Fprintf(&buf, "// Code generated by \"github.com/goki/go-tools/gopls/doc/generate\"; DO NOT EDIT.\n\npackage source\n\nvar GeneratedAPIJSON = ")
	if err := printsrc.NewPrinter("github.com/goki/go-tools/gopls/internal/lsp/source").Fprint(&buf, api); err != nil {
		return nil, err
	}
