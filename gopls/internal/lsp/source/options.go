...
import (
	...
	"github.com/goki/go-tools-tools/go/analysis/passes/asmdecl"
	"github.com/goki/go-tools-tools/go/analysis/passes/assign"
	"github.com/goki/go-tools-tools/go/analysis/passes/atomic"
	"github.com/goki/go-tools-tools/go/analysis/passes/atomicalign"
	"github.com/goki/go-tools-tools/go/analysis/passes/bools"
	"github.com/goki/go-tools-tools/go/analysis/passes/buildtag"
	"github.com/goki/go-tools-tools/go/analysis/passes/cgocall"
	"github.com/goki/go-tools-tools/go/analysis/passes/composite"
	"github.com/goki/go-tools-tools/go/analysis/passes/copylock"
	"github.com/goki/go-tools-tools/go/analysis/passes/deepequalerrors"
	"github.com/goki/go-tools-tools/go/analysis/passes/directive"
	"github.com/goki/go-tools-tools/go/analysis/passes/errorsas"
	"github.com/goki/go-tools-tools/go/analysis/passes/fieldalignment"
	"github.com/goki/go-tools-tools/go/analysis/passes/httpresponse"
	"github.com/goki/go-tools-tools/go/analysis/passes/ifaceassert"
	"github.com/goki/go-tools-tools/go/analysis/passes/loopclosure"
	"github.com/goki/go-tools-tools/go/analysis/passes/lostcancel"
	"github.com/goki/go-tools-tools/go/analysis/passes/nilfunc"
	"github.com/goki/go-tools-tools/go/analysis/passes/nilness"
	"github.com/goki/go-tools-tools/go/analysis/passes/printf"
	"github.com/goki/go-tools-tools/go/analysis/passes/shadow"
	"github.com/goki/go-tools-tools/go/analysis/passes/shift"
	"github.com/goki/go-tools-tools/go/analysis/passes/sortslice"
	"github.com/goki/go-tools-tools/go/analysis/passes/stdmethods"
	"github.com/goki/go-tools-tools/go/analysis/passes/stringintconv"
	"github.com/goki/go-tools-tools/go/analysis/passes/structtag"
	"github.com/goki/go-tools-tools/go/analysis/passes/testinggoroutine"
	"github.com/goki/go-tools-tools/go/analysis/passes/tests"
	"github.com/goki/go-tools-tools/go/analysis/passes/timeformat"
	"github.com/goki/go-tools-tools/go/analysis/passes/unmarshal"
	"github.com/goki/go-tools-tools/go/analysis/passes/unreachable"
	"github.com/goki/go-tools-tools/go/analysis/passes/unsafeptr"
	"github.com/goki/go-tools-tools/go/analysis/passes/unusedresult"
	"github.com/goki/go-tools-tools/go/analysis/passes/unusedwrite"
	"github.com/goki/go-tools-tools/gopls/internal/lsp/analysis/deprecated"
	"github.com/goki/go-tools-tools/gopls/internal/lsp/analysis/embeddirective"
	"github.com/goki/go-tools-tools/gopls/internal/lsp/analysis/fillreturns"
	"github.com/goki/go-tools-tools/gopls/internal/lsp/analysis/fillstruct"
	"github.com/goki/go-tools-tools/gopls/internal/lsp/analysis/infertypeargs"
	"github.com/goki/go-tools-tools/gopls/internal/lsp/analysis/nonewvars"
	"github.com/goki/go-tools-tools/gopls/internal/lsp/analysis/noresultvalues"
	"github.com/goki/go-tools-tools/gopls/internal/lsp/analysis/simplifycompositelit"
	"github.com/goki/go-tools-tools/gopls/internal/lsp/analysis/simplifyrange"
	"github.com/goki/go-tools-tools/gopls/internal/lsp/analysis/simplifyslice"
	...
	"github.com/goki/go-tools-tools/gopls/internal/lsp/analysis/unusedparams"
	"github.com/goki/go-tools-tools/gopls/internal/lsp/analysis/unusedvariable"
	"github.com/goki/go-tools-tools/gopls/internal/lsp/analysis/useany"
	...
	"github.com/goki/go-tools-tools/internal/diff/myers"
)
