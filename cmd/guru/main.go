...
package main // import "github.com/goki/go-tools/cmd/guru"
...
The -json flag causes guru to emit output in JSON format;
	github.com/goki/go-tools/cmd/guru/serial defines its schema.
...
The -scope flag restricts analysis to the specified packages.
	Its value is a comma-separated list of patterns of these forms:
		github.com/goki/go-tools/cmd/guru     # a single package
		github.com/goki/go-tools/...          # all packages beneath dir
...
Example: describe syntax at offset 530 in this file (an import spec):
  ...
  $ guru describe src/github.com/goki/go-tools/cmd/guru/main.go:#530
`
