...
package main // import "github.com/goki/go-tools/cmd/callgraph"
...
import (
	...
	"github.com/goki/go-tools/go/callgraph/static"
	"github.com/goki/go-tools/go/callgraph/vta"
...
-format    Specifies the format in which each call graph edge is displayed.
           One of:
            ...
            digraph     output suitable for input to
                        github.com/goki/go-tools/cmd/digraph.
...
Examples:
  ...
  Show all functions directly called by the callgraph tool's main function:
    ...
    callgraph -format=digraph github.com/goki/go-tools/cmd/callgraph |
      digraph succs github.com/goki/go-tools/cmd/callgraph.main
`
